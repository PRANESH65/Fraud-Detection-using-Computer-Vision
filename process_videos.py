...
def process_video(video_path, output_video_path):
    ...
    while True:
        ...
        for i in indexes.flatten():
            ...
            if class_id == 0:  # ID for cash 
                cash_detected = True
            if class_id == 1:  # ID for invoice
                invoice_issued = True
...
# Process videos
process_video('../videos/cash_no_invoice_30sec.mp4', '../outputs/cash_no_invoice_processed.mp4')
process_video('../videos/multiple_cash_transaction_raw_example.mp4', '../outputs/multiple_cash_processed.mp4')